...
local function Ripper()
    ...
    local cameraShaker =
        require(repStorage.CameraShaker)
    ...
    local rawUrl =
        "https://raw.githubusercontent.com/Francisco1692qzd/RevivedOldHardcore/main/oldRipper.rbxml.rbxm"
    ...
    spawn(function()
        ...
        do
            ...
            and v.Character.HumanoidRootPart then
                ...
                and not v.Character:GetAttribute(
                    "Hiding"
                ) then
                    ...
                    coroutine.wrap(function()
                        ...
                        firesignal(
                                ...
                                .OnClientEvent,
                            {
                                ...
                                "It's presence is known by the red lights...",
